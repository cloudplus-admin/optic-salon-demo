...
function openEditor(type,item=null){
  ...
  $('#entityEyebrow').textContent=item?'Редактирование':'Новая запись';$('#entityTitle').textContent=type==='service'?t(item?'service.edit_title':'service.create_title'):`${item?'Редактирование':'Создание'} ${schema.title}`;
